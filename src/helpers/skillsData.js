...
const skills = [
  ...
  {
    name: "CSS Frameworks (Bootstrap, Tailwind CSS, Material-UI)",
  ...
  {
    name: "Basic Back-End Knowledge (Node.js)",
    description: "Familiarity with Node.js for back-end development.",
    icon: FaNodeJs,
  },
  {
    name: "Basic UX/UI Knowledge",
    description: "Understanding of UX/UI principles for better design.",
    icon: FaPencilRuler,
  },
  {
  ...
  {
    name: "Time Management and Collaboration Tools (Slack, Jira)",
    description:
      "Experience with tools for productivity and team collaboration.",
    icon: FaUsers,
  },
  {
    name: "AI Tools for Productivity and Problem-Solving",
    description:
      "Skilled in using AI tools to enhance workflow and solve problems.",
    icon: FaBrain,
  },
  {
    name: "WebSockets",
    description:
      "Experience in implementing real-time communication using WebSockets.",
    icon: FaPlug,
  },
  {
    name: "Vitest",
  ...
  {
    name: "Caching (node-cache)",
    description:
      "Implemented caching for external APIs to reduce requests and improve performance.",
    icon: FaDatabase,
  },
  {
  ...
  },
  {
    ...
    description:
      "Authored Swagger docs for created endpoints.",
    icon: FaBook,
  },
  {
    name: "Seeding Scripts",
    description:
      "Wrote seed scripts for quick database setup.",
    icon: FaLeaf,
  },
  {
    name: "Scrum Master / Agile Leadership",
    description:
      "Organized sprints, maintained a Gantt chart, and led Agile ceremonies.",
